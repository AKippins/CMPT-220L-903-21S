	...
	// write your code here
        ...
        public class Main {
            ...
            static void dry_inventory() {
                ...
                {
                    int p =scan.nextInt();
                    System.out.println("How many prezels do yu want to buy");
                    int l =scan.nextInt();
                    System.out.println("How many lemonades do you wanna buy");
                    int t =scan.nextInt();
                    System.out.println("Do you wanna leave a tip?");
                    lemonades_available-= p;
                    pretzels_available-= l;
                    tips+= t;


                    int c=scan.nextInt();
                    System.out.println("is there anothjer customer? yes-1 no-2");
